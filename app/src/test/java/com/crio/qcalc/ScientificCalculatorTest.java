...
Assertions.assertEquals(1.0, scientificCalculator.modulo_double(5.0, 2.0), 0.001);
Assertions.assertEquals(0.0, scientificCalculator.modulo_double(10.0, 2.0), 0.001);
